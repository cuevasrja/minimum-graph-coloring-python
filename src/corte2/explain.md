...
- Los algoritmos de búsqueda tabú y recocido simulado, aunque no lograron superar las soluciones anteriores, demostraron ser útiles para explorar nuevas áreas del espacio de soluciones y evitar óptimos locales.
...
- El algoritmo genético, aunque no logró superar las soluciones anteriores, demostró ser útil para explorar nuevas áreas del espacio de soluciones y generar soluciones alternativas. Sin embargo, en general, requirió una mayor cantidad de recursos computacionales en comparación con los métodos anteriores. Quizás con un estudio más profundo de los hiperparámetros y mayor tiempo de ejecución, se podrían obtener mejores resultados con este algoritmo.
